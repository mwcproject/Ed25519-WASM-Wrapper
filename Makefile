...
npm:
	...
	echo "try { module[\"exports\"] = require(\"@nicolasflamel/ed25519-native\");} catch(error) { const ed25519 = (typeof WebAssembly !== \"undefined\") ? require(\"./wasm.js\") : require(\"./asm.js\");" > "./index.js"
